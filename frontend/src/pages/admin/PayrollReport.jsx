...
export default function PayrollReport() {
  ...
  return (
    <div className="space-y-6">
      <div><h1 className="text-2xl sm:text-3xl font-bold text-foreground">Payroll Report</h1><p className="text-muted-foreground mt-1">Salary deductions from excess leave</p></div>
