...
export default function LeaveHistory() {
  ...
  return (
    <div className="space-y-6">
      <div><h1 className="text-2xl sm:text-3xl font-bold text-foreground">Leave History</h1><p className="text-muted-foreground mt-1">Organization-wide leave history</p></div>
      ...
      {loading ? <p>Loading...</p> : leaves.length === 0 ? <div className="text-center py-16"><span className="text-5xl block mb-4">📋</span><h3 className="font-semibold text-foreground">No leaves found</h3></div> : (
        <div className="bg-card border border-border rounded-xl overflow-hidden"><div className="overflow-x-auto"><table className="min-w-[760px] w-full text-sm">
